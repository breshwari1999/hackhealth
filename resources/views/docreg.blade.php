...
<div class="container">
<br>
<form class="form-horizontal" action="/docreg" method="post" enctype="multipart/form-data">
@csrf
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <label>Qualification</label>
                <input type="text" class="form-control" name="quali" id="name" aria-describedby="emailHelp" placeholder="Enter  Qualification" required>
         </div>
    </div>
</div>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <label>Specialization</label>
                <input type="text" class="form-control" name="spec" id="name" aria-describedby="emailHelp" placeholder="Enter  Specialization" required>
            </div>
        </div>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <label>Experience</label>
                <input type="text" class="form-control" name="exp" id="name" aria-describedby="emailHelp" placeholder="Enter  Experience" required>
            </div>
        </div>
    </div>
...
<div class="jumbotron">
    <h4 style="text-align:center">Clinic Details</h4>
    ...
    <div class="col-sm-12">
        <div class="form-group">
            <label>Clinic Name</label>
                <input type="text" class="form-control" name="clinic" id="clinic" aria-describedby="emailHelp" placeholder="Enter clinic  Name" required>
            </div>
        </div>
    </div>
...
<div class="row">
        ...
        <div class="form-group">
                   <label>Address</label>
                    <input type="text" class="form-control" name="add" id="name" aria-describedby="emailHelp" placeholder="Enter clinic Address" required>
                </div>
        </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
            <label for="">Upload Photo</label>
                <input type="file" class="form-control" placeholder=""  name="image1" style="height:44px" required>
            </div>
        </div>
    </div>
<div class="row">
        ...
        <div class="form-group">
                   <label>Location</label>
                    <input type="text" class="form-control" name="loc" id="name" aria-describedby="emailHelp" placeholder="Enter clinic  Location" required>
                </div>
        </div>
</div>
  </div>
